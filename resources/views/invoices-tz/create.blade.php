    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row invoice-add">
                                    ...
                                    <dl class="row mb-2">
                                        ...
                                        <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                                            <div class="input-group input-group-merge disabled w-px-150">
                                                ...
                                                @php
                                                    $invoice_no = now()->year . 'NGT' . str_pad(\App\Models\Invoice::where('branch','tanzania')->count() + 1, 3, '0', STR_PAD_LEFT);
                                                @endphp
                                                  <input type="text" class="form-control" disabled=""
                                                  placeholder="{{ $invoice_no }}" value="{{ $invoice_no }}" id="invoiceId">
                                              <input type="hidden" class="form-control"name="invoice_no" value="{{ $invoice_no }}">
                                              <input type="hidden" class="form-control"name="branch" value="tanzania">
                                            </div>
                                        </dd>
                                        <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end ps-0">
                                    ...
                                    <table id="item_table" style="width: 97%">
                                        <tr>
                                            <td>
                                                <div class="row mb-3">
                                                    <div class="col-7">
                                                        <label class="form-label fs-6" for="training">Training Name</label>
                                                    ...
                                                    <div class="col-2">
                                                        <label class="form-label fs-6" for="training_discount">Discout (%)</label>
                                ...
                                <div class="col-md-6 mb-md-0 mb-3">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <input type="text" class="form-control ms-3" name="salesperson"
                                            value="{{ old('salesperson') }}" id="salesperson" required
            ...
            {{-- <div class="col-lg-3 col-12 invoice-actions">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="form-check custom-option custom-option-basic checked mb-3">
                            <label
                                class="form-check-label custom-option-content form-check-input-payment d-flex gap-3 align-items-center"
                                for="rwanda">
                                <input name="branch" class="form-check-input" type="radio"
                                    value="rwanda" id="rwanda" checked="">
                                <span class="custom-option-body">
                                    <img src="{{ asset('assets/img/nziza/rda.png') }}"
                                        alt="visa-card" width="58"
                                        data-app-light-img="nziza/rda.png"
                                        data-app-dark-img="nziza/rda.png">
                                    <span class="ms-3">Rwanda</span>
                                </span>
                            </label>
                        </div>
                        <div class="form-check custom-option custom-option-basic">
                            <label
                                ...
                                for="tanzania">
                                <input name="branch" class="form-check-input" type="radio"
                                    value="tanzania" id="tanzania">
                                <span class="custom-option-body">
                                    <img src="{{ asset('assets/img/nziza/tzd.png') }}"
                                        alt="tanzania" width="58"
                                        data-app-light-img="nziza/tzd.png"
                                        data-app-dark-img="nziza/tzd.png">
                                    <span class="ms-3">Tanzania</span>
                                </span>
                            </label>
                        </div>
                    </div>
