        ...
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Invoice List
                    ...
                    <a class="btn btn-dark text-white pull-left float-end" href="{{ route('invoice.create_tz') }}"><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                        ...
                        @foreach ($invoices as $item)
                            <tr class="odd">
                                <td class="sorting_1"><a
                                        href="{{ route('invoice.show_tz', $item->id) }}">#{{ $item->invoice_no }}</a></td>
                                <td><span
                                ...
                                <td class="d-flex align-items-center">
                                    <div><a href="javascript:;" data-bs-toggle="tooltip" class="text-body"
                                        ...
                                        <a href="{{ route('invoice.show_tz', $item->id) }}" data-bs-toggle="tooltip"
                                        ...
                                        <a href="{{ route('invoice.download',$item->id) }}" data-bs-toggle="tooltip" class="text-body"
                                            data-bs-placement="top" aria-label="Preview Invoice"
                                            data-bs-original-title="Download"><i
                                                class="ti ti-download mx-2 ti-sm"></i></a>
                                        <a href="{{ route('invoice.edit_tz', $item->id) }}" data-bs-toggle="tooltip"
                                            class="text-body" data-bs-placement="top" aria-label="Preview Invoice"
