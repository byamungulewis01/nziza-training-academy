                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('licence.store') }}" class="row g-3" method="post">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="name" name="name"
                                                    class="form-control" placeholder="Licence Name"
                                                    value="{{ old('name') }}" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="price">Price</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="licence_type" class="form-select" id="licence_type">
                                                    <option {{ old('licence_type') == 'lifetime' ? 'selected': '' }} value="lifetime" selected>Lifetime</option>
                                                    <option {{ old('licence_type') == 'annual' ? 'selected': '' }} value="annual">Annual</option>
                                                    <option {{ old('licence_type') == 'other' ? 'selected': '' }} value="other">Other</option>
                                                </select>
                                            </div>
                                            <div class="col-12 text-center">
                                                <button type="submit"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{ route('licence.update', $item->id) }}"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="form-label" for="licence_type">Licence Type</label>
                                                                    <select name="licence_type" class="form-select" id="licence_type">
                                                                        <option {{ $item->licence_type == 'lifetime' ? 'selected': '' }} value="lifetime" selected>Lifetime</option>
                                                                        <option {{ $item->licence_type == 'annual' ? 'selected': '' }} value="annual">Annual</option>
                                                                        <option {{ $item->licence_type == 'other' ? 'selected': '' }} value="other">Other</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-12 text-center">
                                                                    <button type="submit"
