    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Create Goals
                </h5>
            </div>
            <div class="card-body">
                <div class="row px-0 px-sm-4">
                    <form action="{{ route('monthly_goals.store') }}" method="post">
                                                ...
                                                <div class="row w-100 p-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-12 mb-md-0 mb-3">
                                                                ...
                                                                <input type="number" name="revenue[]" required
                                                                    class="form-control mb-3" placeholder="00"
                                                                    min="1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12 mb-md-0 mb-3">
                                                        ...
                                                        <input type="text" class="form-control mb-3"
                                                            name="client_name[]"
                                                            placeholder="Company or Client Name ..." required>
