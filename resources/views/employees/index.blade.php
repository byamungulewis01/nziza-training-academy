                ...
                <table class="datatables table border-top">
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td><span class="text-truncate d-flex align-items-center">{{ $item->phone }}</span></td>
                            ...
                            <td>
                                <div class="d-flex align-items-center"><a href="javascript:;" class="text-body"><i
                                            class="ti ti-edit ti-sm me-2"></i></a><a href="javascript:;"
            ...
            <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="newUserForm" action="{{ route('employees.store') }}" class="row g-3" method="post"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="phone" name="phone"
                                        class="form-control phone-number-mask" maxLength="10" placeholder="xxx xxx xxxx"
                                        value="{{ old('phone') }}" />
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
