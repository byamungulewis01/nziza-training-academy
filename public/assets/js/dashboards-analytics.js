...
!function(){
    ...
    o=isDarkStyle?(e=config.colors_dark.cardColor,
        ...
        r="dark","#5E6692"):(e=config.colors.cardColor,a=config.colors.textMuted,t=config.colors.headingColor,r="","#817D8D");
        ...
        s.length&&(s.DataTable({
            ...
            columnDefs:[
                ...
                },
                {
                    ...
                    render:function(e,t,a,r){
                        ...
                        s=a.project_name,
                        i=a.date;
                        return'<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar me-2">'+
                        (o?'<img src="'+assetsPath+"img/icons/brands/"+o+'" alt="Avatar" class="rounded-circle">':
                        '<span class="avatar-initial rounded-circle bg-label-'+["success","danger","warning","info","primary","secondary"][Math.floor(6*Math.random())]+'">'+
                        (o=(((o=(s=a.project_name).match(/\b\w/g)||[]).shift()||"")+(o.pop()||"")).toUpperCase())+"</span>")+'</div></div><div class="d-flex flex-column"><span class="text-truncate fw-semibold">'+s+'</span><small class="text-truncate text-muted">'+i+"</small></div></div>"
                    }
                },
                {
                    targets:4,
                    ...
                    searchable:!1,
                    render:function(e,t,a,r){
                        for(var o=a.team,s='<div class="d-flex align-items-center avatar-group">',i=0;i<o.length;i++)s+='<div class="avatar avatar-sm"><img src="'+assetsPath+"/img/avatars/"+o[i]+'" alt="Avatar" class="rounded-circle pull-up"></div>';return s+="</div>"
                    }
                },
                {
                    targets:-2,
            ...
            dom:'<"card-header pb-0 pt-sm-0"<"head-label text-center"><"d-flex justify-content-center justify-content-md-end"f>>t<"row mx-2"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',displayLength:5,
