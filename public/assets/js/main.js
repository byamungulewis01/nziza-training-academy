                        ...
                        o
                            .typeahead(
                                ...
                                },
                                {
                                    ...
                                    source: t(a),
                                    templates: {
                                        header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Search Results</h6>',
                                        suggestion: function ({
                                            name: e,
                                            photo: t,
                                            regNumber: a,
                                            ...
                                            return (
                                                '<a href="/profile/' +
                                                id +
                                                '"><div class="d-flex align-items-center"><img class="rounded-circle me-3" src="' +
                                                assetsPath +
                                                "img/avatars/" +
                                                t +
                                                '" alt="' +
                                        ...
                                        notFound:
                                            '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Search Results</h6><p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p></div>',
                                    },
                                }
                            )
