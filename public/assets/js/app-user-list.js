    ...
    n.length&&(e=n.DataTable({
        ...
        columnDefs:[
            ...
            },
            {
                ...
                render:function(e,t,a,s){
                    var n=a.full_name, i=a.email, o=a.avatar;
            ...
            },
            {
                ...
                render:function(e,t,a,s){
                    ...
                    return"<span class='text-truncate d-flex align-items-center'>"+{
                        ...
                        Admin:'<span class="badge badge-center rounded-pill bg-label-secondary w-px-30 h-px-30 me-2"><i class="ti ti-device-laptop ti-sm"></i></span>'}[a]+a+"</span>"
                    }
                },
                {
                    targets:3,
            ...
            buttons:[
                ...
                initComplete:function(){this.api().columns(2).every(function(){
                    var t=this,
